...
//   const id = await productDetail(data.id);
...
//             <!-- 제품 이미지 -->
//             <div class="container_content_productImg">${id.thumbnail}</div>
//             <!-- 제품 정보 -->
...
//                 </div>
//               </section>
//               <div class="product_info_price">${id.price}</div>
...
//                 <div class="count_totalprice">${id.price}</div>
//               </section>
//               <!-- 찜, 장바구니, 구매 버튼 -->
